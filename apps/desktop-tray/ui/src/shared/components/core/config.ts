...
export const buttonConfig = {
  ...
  variants: {
    ...
    outline:
      "bg-surface border border-border-strong hover:bg-surface-hover text-foreground focus:ring-border-strong",
...
export const inputConfig = {
  ...
  iconWrap:
    "absolute left-4 top-1/2 -translate-y-1/2 text-subtle group-focus-within:text-primary transition-colors pointer-events-none",
  paddings: {
    withIcon: "pl-11",
    plain: "pl-4",
    withToggle: "pr-11",
  ...
  passwordToggle:
    "absolute right-4 top-1/2 -translate-y-1/2 text-subtle hover:text-foreground focus:outline-none transition-colors cursor-pointer",
...
export const selectConfig = {
  ...
  variants: {
    outline: {
      normal:
        "bg-surface border-border-strong hover:border-primary/50 text-foreground focus:border-primary",
      error: "bg-surface border-danger text-foreground",
    },
    soft: {
      normal:
        "bg-surface-muted border-transparent hover:bg-surface-hover text-foreground focus:bg-surface focus:border-primary",
  ...
  dropdown:
    "absolute z-50 left-0 right-0 mt-2 bg-surface border border-border rounded-xl shadow-xl overflow-hidden max-h-64 flex flex-col animate-fade-in",
  dropdownSearch: "p-2 border-b border-border flex items-center bg-surface-muted",
  dropdownSearchInput:
    "w-full bg-transparent border-none text-xs focus:outline-none p-1 text-foreground placeholder:text-subtle",
  option: {
...
export const multiselectConfig = {
  ...
  control:
    "w-full flex items-center justify-between rounded-lg border bg-surface text-left text-xs sm:text-sm transition-all focus-within:ring-2 focus-within:ring-primary/10 cursor-pointer min-h-[44px] p-1.5",
  controlStates: {
  ...
  overflowTag:
    "bg-surface-muted border border-border text-muted text-xs font-bold px-2 py-1 rounded-md shrink-0",
  ...
  maxNotice:
    "px-4 py-1.5 bg-warning/10 text-warning text-[10px] font-bold text-center border-b border-warning/20 select-none",
  option: {
...
export const datePickerConfig = {
  ...
  label: selectConfig.label,
  trigger:
    "w-full flex items-center justify-between rounded-lg border h-11 px-4 text-xs sm:text-sm font-semibold transition-all focus:ring-2 focus:ring-primary/15 text-foreground bg-surface text-left cursor-pointer",
  triggerStates: {
    normal: "border-border-strong hover:border-primary/50",
    disabled: "opacity-50 pointer-events-none bg-surface-muted border-border",
  },
  popover:
    "absolute z-50 mt-2 bg-surface border border-border rounded-xl shadow-xl p-4 w-72 animate-fade-in right-0 sm:left-0",
  header: "flex items-center justify-between mb-3 border-b border-border pb-2",
  navButton:
    "p-1 hover:bg-surface-muted rounded-lg text-subtle cursor-pointer disabled:opacity-40 disabled:pointer-events-none",
  monthLabel: "text-xs font-bold text-foreground",
  preset:
    "px-2 py-1 bg-surface-muted hover:bg-primary/10 border border-border hover:border-primary/30 rounded text-[10px] font-bold text-muted hover:text-primary cursor-pointer transition-colors",
  lockedNotice:
    "mb-2 px-2 py-1 bg-warning/10 text-warning text-[9px] font-bold rounded border border-warning/20 text-center uppercase tracking-wider select-none",
...
export const dataTableConfig = {
  wrapper:
    "w-full border border-border rounded-xl overflow-hidden bg-surface shadow-sm font-sans text-left",
  scroll: "overflow-x-auto relative max-h-[500px] scrollbar-thin",
  table: "w-full text-xs sm:text-sm text-left border-collapse",
  thead:
    "sticky top-0 bg-surface-muted border-b border-border z-10 text-muted font-bold uppercase select-none",
  ...
  expandButton:
    "p-1 hover:bg-surface-muted rounded text-subtle hover:text-primary transition-colors cursor-pointer",
  ...
  expandedPanel:
    "px-6 py-4 border border-dashed border-border rounded-xl bg-surface shadow-inner animate-fade-in",
...
export const paginationConfig = {
  ...
  arrowButton:
    "border border-border bg-surface rounded-lg hover:bg-surface-hover text-muted transition-all cursor-pointer disabled:opacity-45 disabled:pointer-events-none flex items-center gap-1.5 font-bold",
  arrowSizes: {
    sm: "px-2.5 py-1.5 text-[10px]",
    md: "px-4 py-2.5 text-xs",
  } satisfies Record<PaginationSize, string>,
  iconButton:
    "border border-border bg-surface hover:bg-surface-hover rounded-lg p-2 text-muted disabled:opacity-45 disabled:pointer-events-none cursor-pointer transition-colors",
  page: {
...
export const searchBarConfig = {
  ...
  input:
    "w-full h-11 pl-10 pr-12 rounded-lg border border-border-strong hover:border-primary/50 focus:border-primary focus:ring-2 focus:ring-primary/10 text-xs sm:text-sm font-medium outline-none bg-surface transition-all text-foreground placeholder:text-subtle",
  ...
  paletteTrigger:
    "w-full h-11 px-4 rounded-lg border border-border hover:border-primary/50 bg-surface-muted hover:bg-surface text-left text-xs sm:text-sm font-semibold text-subtle flex items-center justify-between cursor-pointer shadow-inner transition-all",
  overlay:
    "fixed inset-0 bg-overlay/40 backdrop-blur-sm z-50 flex items-start justify-center pt-24 px-4 animate-fade-in",
  palette:
    "bg-surface border border-border rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden flex flex-col max-h-[480px]",
  paletteHeader:
    "p-4 border-b border-border flex items-center justify-between gap-3 bg-surface-muted",
  paletteInput:
    "w-full bg-transparent border-none text-sm font-bold text-foreground focus:outline-none p-1 placeholder:text-subtle",
  resultsPane: "flex-1 overflow-y-auto p-2.5 space-y-3 max-h-[350px] scrollbar-thin",
  result:
    "w-full text-left p-3 hover:bg-primary/5 rounded-xl flex items-center justify-between group transition-colors cursor-pointer border border-transparent hover:border-primary/10",
  resultCategory:
    "text-[9px] uppercase tracking-wider font-extrabold text-accent bg-accent/10 px-1.5 py-0.5 rounded border border-accent/20",
  ...
  resultAction:
    "opacity-0 group-hover:opacity-100 transition-all text-xs text-accent font-extrabold flex items-center gap-1",
...
export const uploadZoneConfig = {
  ...
  fileRow:
    "flex items-center gap-2.5 p-2.5 bg-surface border border-border rounded-xl text-left shadow-sm animate-fade-in",
...
export const badgeConfig = {
  ...
  positions: {
    "standalone-inline":
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold select-none",
    "absolute-top-right":
      "absolute -top-1.5 -right-1.5 z-10 translate-x-1/2 -translate-y-1/2 flex h-5 min-w-5 items-center justify-center rounded-full px-1.5 text-[9px] font-black",
...
export const tooltipConfig = {
  ...
  arrows: {
    ...
    bottom:
      "bottom-full left-1/2 -translate-x-1/2 -mb-1 border-b-inverse border-x-transparent border-t-transparent",
    left: "left-full top-1/2 -translate-y-1/2 -ml-1 border-l-inverse border-y-transparent border-r-transparent",
    right:
      "right-full top-1/2 -translate-y-1/2 -mr-1 border-r-inverse border-y-transparent border-l-transparent",
  } satisfies Record<TooltipPosition, string>,
...
export const accordionConfig = {
  ...
  trigger:
    "w-full flex items-center justify-between p-4 bg-surface-muted/50 hover:bg-surface-hover text-left cursor-pointer focus:outline-none",
...
export const dialogConfig = {
  ...
  panel:
    "bg-surface border border-border shadow-2xl relative z-10 flex flex-col overflow-hidden animate-scale-up",
  ...
  header:
    "px-5 py-4 border-b border-border flex items-center justify-between bg-surface-muted shrink-0",
  title: "text-xs sm:text-sm font-black text-foreground uppercase tracking-widest",
  closeButton:
    "p-1.5 hover:bg-secondary-hover rounded-lg text-subtle hover:text-foreground transition-colors cursor-pointer",
  body: "flex-1 overflow-y-auto p-6 scrollbar-thin text-xs sm:text-sm text-muted font-medium leading-relaxed",
  footer:
    "px-5 py-3.5 border-t border-border bg-surface-muted flex items-center justify-end gap-3 shrink-0",
};
...
export const drawerConfig = {
  ...
  footer:
    "px-5 py-4 border-t border-border bg-surface-muted flex items-center justify-end gap-3 shrink-0",
};
...
export const navbarConfig = {
  ...
  fixations: {
    "sticky-top":
      "sticky top-0 z-40 bg-surface/90 backdrop-blur-md shadow-sm border-b border-border",
...
export const sidebarConfig = {
  ...
  toggle:
    "p-1.5 bg-surface-muted hover:bg-surface-hover border border-border rounded-lg text-muted hover:text-foreground transition-all cursor-pointer shadow-sm",
...
export const offlineQueueConfig = {
  ...
  connectionPill:
    "flex items-center gap-1 text-[9px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded border",
  connection: {
  ...
  statuses: {
    ...
    "pending-upload": {
      container: "bg-primary/5 border-primary/20 animate-pulse",
      icon: "text-primary",
...
export const ocrCanvasConfig = {
  wrapper:
    "border border-border rounded-xl overflow-hidden bg-inverse font-sans shadow-xl flex flex-col h-[420px]",
  toolbar:
    "bg-inverse border-b border-inverse-foreground/10 px-4 py-3 flex items-center justify-between gap-4 select-none shrink-0",
  toolbarTitle: "text-xs font-black text-inverse-foreground/80 uppercase tracking-wider",
  toolButton:
    "p-1.5 hover:bg-inverse-foreground/10 rounded-lg text-inverse-foreground/50 hover:text-inverse-foreground transition-colors cursor-pointer",
  ...
  stage:
    "flex-1 overflow-auto relative p-6 flex items-center justify-center bg-inverse/60 scrollbar-thin",
  document:
    "relative transition-transform duration-200 bg-surface shadow-2xl rounded-lg border border-border max-w-sm w-full aspect-[3/4] overflow-hidden",
  ...
  boxLabel:
    "absolute bottom-full mb-1 left-1/2 -translate-x-1/2 bg-inverse text-inverse-foreground text-[8px] font-black px-1.5 py-0.5 rounded shadow whitespace-nowrap z-50 uppercase tracking-widest",
  footer:
    "bg-inverse border-t border-inverse-foreground/10 px-4 py-2.5 flex items-center justify-between text-[10px] text-inverse-foreground/50 font-bold select-none shrink-0",
